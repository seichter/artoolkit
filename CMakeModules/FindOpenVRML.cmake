...
# Modified by Hartmut Seichter for inclusion into ARToolKit
#


set(OPENVRML_ROOT_DIR CACHE PATH "OpenVRML Binary root directory")
...
if(OPENVRML_INCLUDE_DIR)
	set(OPENVRML_ROOT_DIR ${OPENVRML_INCLUDE_DIR}/../)
endif(OPENVRML_INCLUDE_DIR)
...
IF(WIN32)
	FIND_LIBRARY(OPENVRML_boost_LIBRARY 
		NAMES 
		boost_thread-1_34_1
		libboost_thread-vc80-mt-1_34_1
		PATHS
		${OPENVRML_LIB_SEARCH_PATHS}
	)
ENDIF(WIN32)
